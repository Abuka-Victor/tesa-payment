...
function Index() {
  ...
  return (
    // <div className="h-[100vh] w-full bg-neutral-950 relative flex items-center justify-center antialiased">
    <div className="z-50">
      {/* <div className="flex space-x-4 max-w-6xl mx-auto p-4 z-10"> */}
      <div className="">
        {/* Left Wing */}
        {/* <div className="w-64 shadow-input rounded-2xl p-6 bg-black transform transition-transform duration-500 hover:scale-105 -translate-x-4 hover:translate-x-0"> */}
        <div className="">
        ...
        {/* Main Form */}
        <div className="shadow-input w-full max-w-md rounded-none p-4 md:rounded-2xl md:p-8 bg-black mt-14">
          <div className="shadow-input mx-auto w-full max-w-md rounded-none p-4 md:rounded-2xl md:p-8 bg-black mt-14">
            ...
            <form className="my-8" onSubmit={handleSubmit}>
              ...
              <LabelInputContainer className="mb-4">
                ...
                <Select>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="wood">Wood Engineering</SelectItem>
              ...
              <LabelInputContainer className="mb-8">
                ...
                <Input id="session" placeholder="2023/2024" type="session" />
              </LabelInputContainer>
